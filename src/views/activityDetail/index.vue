...
export default {
  ...
  data () {
    return {
      ...
      items: 18,
      imgGood: [require('../../assets/image/switch.jpg'), require('../../assets/image/switch_2.jpg'), require('../../assets/image/switch_3.png')],
      ...
      imgSponsor: [require('../../assets/image/switch_2.jpg'), require('../../assets/image/switch_3.png'), require('../../assets/image/switch.jpg')],
      lotteryButton: true,
      afterJoin: false,
